...
public class Trial {
	...
	public Trial(String soundFile, int visualHz, boolean congruent,
	...
	public String toScriptString() {
		return specs.get(0) + " " + specs.get(1) + " " + specs.get(2) + " "
				+ specs.get(3) + " " + specs.get(4) + " " + specs.get(5) + " "
				+ specs.get(6).toString() + "\n";
	}
}

 ...
 * The events of interest are generally keypresses after a
 * fish is released, but sometimes there will be no keypress 
 * for a fish and this is indicated using a 0 for the keyCharacter
 * The elements of interest are the response time
 * @author tim
 *
 */

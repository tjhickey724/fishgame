...
public class GameModel {
	...
	private List<Fish> actors = new ArrayList<Fish>();
	...
	public Fish removeLastFish() {
		if (this.actors.size() > 0) {
			Fish lastFish = this.actors.get(0);
	...
	public List<Fish> getActorList() {
		return new ArrayList<Fish>(this.actors);
	}
	...
	public synchronized void handleKeyPress(KeyEvent e,AudioClip goodclip, AudioClip badclip) {
		...
		Fish lastFish = getActorList().get(0);
